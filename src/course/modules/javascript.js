...
const lesson19 = {
  ...
  theory: [
    ...
    { p: 'Консоль всегда открыта — она находится под превью. Туда попадают `console.log()`, предупреждения, ошибки с номером строки и вызовы `alert()`: так они не блокируют проверку.' },
    { h: 'Синтаксис' },
